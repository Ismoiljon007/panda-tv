                ...
                <div class="subscriptions__bottom">
                    ...
                    <div class="subscriptions__bottom-wrapper">
                        <ul class="subscriptions__nav">
                            <li @click="subs = 'subs'" :class="subs == 'subs' ? 'subscriptions-nav-item-active' : ''">
                                Obuna
                                sotib olish</li>
                                ...
                                <div class="subscriptions__tarrif" v-for="item in activePlan" :key="item">
                                    ...
                                    <div class="subscriptions__tarrif-bottom">
                                        ...
                                        <h4 class="subscriptions__tarrif-price">{{
                                            item?.subscription_plan?.duration_days }}
                                            kunga {{
...
async function activePlanGet() {
    const data: any = await services.activePlan(store.userInfo?.id, authStore.token)
